  ...
  return (
    <div className='h-screen'>
      ...
      <div className=' bg-violet-700 bg-opacity-50 h-auto mt-24 mx-3 rounded-2xl p-1 shadow-2xl  md:mx-52 md:mt-12 '>
        <form className=' flex flex-col mx-3 my-2 items-center'>
          ...
          <p className='mb-3 text-[1.15rem] text-white'>Ce aspecte pozitive sau negative ai observat la antrenamentul de azi? Detaliaza...</p>
          <textarea 
            placeholder={"Write here..."} 
          ...
          <p className='mb-3 text-[1.15rem] text-white'>Consideri ca ti-ai atins obiectivul la antrenamentul de azi sau a fost un flop?</p>
          <textarea 
            placeholder={"Write here..."} 
